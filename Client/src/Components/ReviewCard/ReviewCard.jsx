...
function ReviewCard(props) {
  return (
    <div className="bg-white w-[15rem] md:w-[37rem] h-[30rem] md:h-full my-4 mx-[1.5rem] md:mx-[3.75rem] flex-shrink-0 py-7 px-8 shadow-md rounded-[10px] flex flex-col items-center">
